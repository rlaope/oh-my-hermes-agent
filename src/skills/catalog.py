...
_DEFINITIONS = [
    ...
    SkillDefinition(
        ...
        phase="durable-goals",
        hermes_role="codex-handoff-guidance",
        handoff_policy="Use Hermes to maintain durable goal/checkpoint state; delegate coding milestones to the selected coding executor and report only observed runtime evidence.",
