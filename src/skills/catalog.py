...
_DEFINITIONS = [
    ...
    SkillDefinition(
        ...
        hermes_role="retained-cognition",
        delegation_boundary="retained-catalog-intent",
        handoff_policy="Keep process orchestration, source/codebase research, planning, review framing, docs-sync checks, PR narration, and evidence boundaries in Hermes; convert implementation into a selected executor handoff such as Codex, Claude Code, another coding agent, or explicit Hermes-retained work only when the user accepts that owner.",
        ...
        expected_outputs=("ralplan-ready context and plan", "ultragoal or selected executor handoff", "code-review gate", "docs sync checklist", "PR-ready summary with observed evidence and gaps"),
